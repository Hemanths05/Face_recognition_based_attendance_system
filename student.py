...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        dep_combo["values"]=("Select Department","BTECH IT","BE CSE","BE MECH","BTECH AIDS","BE CIVIL")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","IT","CSE","EEE","ECE","CIVIL")
        cou_combo.current(0)
            ...
            try:
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path="C:\\Users\\matha\\OneDrive\\Desktop\\Python-FYP-Face-Recognition-Attendence-System-master (1)\\Python_Test_Projects\\data_img\\student."+str(id)+"."+str(img_id)+".jpg"
