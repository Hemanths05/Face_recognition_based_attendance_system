...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\face-off-banner (1).jpg")
        ...
        img1=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\log1.png")
...
# This part is image labels setting start 
        # first header image  
        # img=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\bgnew1.jpg")
        # img=img.resize((1366,130),Image.LANCZOS)
        # self.photoimg=ImageTk.PhotoImage(img)

        # # set image as lable
        # f_lb1 = Label(self.root,image=self.photoimg)
        # f_lb1.place(x=0,y=0,width=1300,height=170)

        # backgorund image 
        bg1=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\bgnew.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Facial Recognition Based Attendance System - (FRAS)",font=("verdana",25,"bold"),bg="black",fg="white")
        title_lb1.place(x=0,y=0,width=1300,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\std1.jpg")
        std_img_btn=std_img_btn.resize((180,180),Image.LANCZOS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.student_pannels,image=self.std_img1,cursor="hand2")
        std_b1.place(x=250,y=240,width=180,height=180)
        ...
        det_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\det1.jpg")
        det_img_btn=det_img_btn.resize((180,180),Image.LANCZOS)
        self.det_img1=ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img,command=self.face_rec,image=self.det_img1,cursor="hand2",)
        det_b1.place(x=480,y=240,width=180,height=180)
        ...
        att_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\att.jpg")
        att_img_btn=att_img_btn.resize((180,180),Image.LANCZOS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,command=self.attendance_pannel,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=710,y=240,width=180,height=180)
        ...
        # hlp_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\tra1.jpg")
        tra_img_btn=tra_img_btn.resize((180,180),Image.LANCZOS)
        self.tra_img1=ImageTk.PhotoImage(tra_img_btn)

        tra_b1 = Button(bg_img,command=self.train_pannels,image=self.tra_img1,cursor="hand2",)
        tra_b1.place(x=940,y=240,width=180,height=180)

        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        tra_b1_1.place(x=940,y=420,width=180,height=45)

        # Photo   button 6
        # pho_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\qr1.png")
        ...
        # Developers   button 7
        # dev_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\dev.jpg")
        ...
        # exit   button 8
        # exi_img_btn=Image.open(r"C:\Users\matha\OneDrive\Desktop\Python-FYP-Face-Recognition-Attendence-System-master (1)\Python_Test_Projects\Images_GUI\exi.jpg")
